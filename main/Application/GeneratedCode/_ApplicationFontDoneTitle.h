...
#include "_EwFont_Roboto_HC56_C16.h"

/* Font for done message title */
EW_DEFINE_FONT_RES( ApplicationFontDoneTitle )
  EW_FONT_ENTRY( EwFont_Roboto_HC56_C16, 56, 56, 1, 0, 0, 16 )

  EW_FONT_RANGES( ApplicationFontDoneTitle )

  EW_FONT_MAPPINGS( ApplicationFontDoneTitle )
    EW_FONT_MAPPING( ApplicationFontDoneTitle, Default, 0 )

  EW_FONTS_TABLE( ApplicationFontDoneTitle )
    EW_FONT( ApplicationFontDoneTitle, Default )
EW_END_OF_FONT_RES( ApplicationFontDoneTitle )
