...
#include "_EwFont_Roboto_HC108_C16.h"

/* Large font for timer display (108px = 2x FontExtraLarge) */
EW_DEFINE_FONT_RES( ApplicationFontTimer )
  EW_FONT_ENTRY( EwFont_Roboto_HC108_C16, 108, 108, 1, 0, 0, 16 )

  EW_FONT_RANGES( ApplicationFontTimer )

  EW_FONT_MAPPINGS( ApplicationFontTimer )
    EW_FONT_MAPPING( ApplicationFontTimer, Default, 0 )

  EW_FONTS_TABLE( ApplicationFontTimer )
    EW_FONT( ApplicationFontTimer, Default )
EW_END_OF_FONT_RES( ApplicationFontTimer )
