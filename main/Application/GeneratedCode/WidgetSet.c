...
static const XPoint _Const0003 = { 46, 26 };
...
/* Include a file containing the bitmap resource : 'WidgetSet::SwitchSmall' */
#include "_WidgetSetSwitchSmall.h"
...
EW_DEFINE_AUTOOBJECT( WidgetSetSwitch_Lime_Small, WidgetSetToggleButtonConfig )

/* Initializer for the auto object 'WidgetSet::Switch_Lime_Small' */
void WidgetSetSwitch_Lime_Small__Init( WidgetSetToggleButtonConfig _this )
{
  ...
  WidgetSetToggleButtonConfig_OnSetFaceOnBitmapActive( _this, EwLoadResource( &WidgetSetSwitchSmall, 
  ResourcesBitmap ));
  WidgetSetToggleButtonConfig_OnSetFaceOnBitmapFocused( _this, EwLoadResource( &WidgetSetSwitchSmall, 
  ResourcesBitmap ));
  WidgetSetToggleButtonConfig_OnSetFaceOnBitmapDisabled( _this, EwLoadResource( 
  &WidgetSetSwitchSmall, ResourcesBitmap ));
  WidgetSetToggleButtonConfig_OnSetFaceOnBitmapDefault( _this, EwLoadResource( &WidgetSetSwitchSmall, 
  ResourcesBitmap ));
  ...
  WidgetSetToggleButtonConfig_OnSetFaceOffBitmapActive( _this, EwLoadResource( &WidgetSetSwitchSmall, 
  ResourcesBitmap ));
...
/* Re-Initializer for the auto object 'WidgetSet::Switch_Lime_Small' */
void WidgetSetSwitch_Lime_Small__ReInit( WidgetSetToggleButtonConfig _this )
{
  EW_UNUSED_ARG( _this );
}

/* Table with links to derived variants of the auto object : 'WidgetSet::Switch_Lime_Small' */
EW_DEFINE_AUTOOBJECT_VARIANTS( WidgetSetSwitch_Lime_Small )
EW_END_OF_AUTOOBJECT_VARIANTS( WidgetSetSwitch_Lime_Small )
