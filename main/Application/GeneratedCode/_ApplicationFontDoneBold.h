...
#include "_EwFont_Roboto_B_HC56_C16.h"

/* Bold font for done message subtitle */
EW_DEFINE_FONT_RES( ApplicationFontDoneBold )
  EW_FONT_ENTRY( EwFont_Roboto_B_HC56_C16, 56, 56, 1, 0, 0, 16 )

  EW_FONT_RANGES( ApplicationFontDoneBold )

  EW_FONT_MAPPINGS( ApplicationFontDoneBold )
    EW_FONT_MAPPING( ApplicationFontDoneBold, Default, 0 )

  EW_FONTS_TABLE( ApplicationFontDoneBold )
    EW_FONT( ApplicationFontDoneBold, Default )
EW_END_OF_FONT_RES( ApplicationFontDoneBold )
