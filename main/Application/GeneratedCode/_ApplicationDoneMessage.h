...
#ifndef _ApplicationDoneMessage_H
#define _ApplicationDoneMessage_H
...
EW_DEFINE_FIELDS( ApplicationDoneMessage, CoreGroup )
  EW_OBJECT  ( DoneTitle,       ViewsText )
  EW_OBJECT  ( DoneSubtitle,    ViewsText )
  EW_OBJECT  ( DismissTouchHandler, CoreSimpleTouchHandler )
  EW_OBJECT  ( DismissTimer,    CoreTimer )
  EW_PROPERTY( OnExpired,       XSlot )
  EW_ARRAY   ( DoneEnjoyTexts,  XString, [6])
  EW_PROPERTY( ModeIndex,       XInt32 )
EW_END_OF_FIELDS( ApplicationDoneMessage )

/* Virtual Method Table (VMT) for the class : 'Application::DoneMessage' */
EW_DEFINE_METHODS( ApplicationDoneMessage, CoreGroup )
...
EW_END_OF_METHODS( ApplicationDoneMessage )
...
#endif /* _ApplicationDoneMessage_H */
