...
EW_DEFINE_BITMAP_FONT( EwFont_Roboto_HC14_C16, 11, 3, 0, 16 )
  EW_FONT_GLYPH( 0x0000, 0, -9, 5, 9, 5, 0x00000000 ),
  EW_FONT_GLYPH( 0x0020, 0, 0, 0, 0, 3, 0x000000B1 ),                  /* ' ' */
  EW_FONT_GLYPH( 0x0021, 0, -9, 3, 9, 3, 0x000000B1 ),                 /* '!' */
  EW_FONT_GLYPH( 0x0022, 0, -9, 4, 3, 4, 0x000000E8 ),                 /* '"' */
  EW_FONT_GLYPH( 0x0023, 0, -9, 8, 9, 7, 0x00000110 ),                 /* '#' */
  EW_FONT_GLYPH( 0x0024, 0, -11, 7, 13, 7, 0x00000216 ),               /* '$' */
  EW_FONT_GLYPH( 0x0025, 0, -9, 9, 9, 9, 0x00000343 ),                 /* '%' */
  EW_FONT_GLYPH( 0x0026, 0, -9, 8, 9, 7, 0x00000444 ),                 /* '&' */
  EW_FONT_GLYPH( 0x0027, 0, -9, 2, 3, 2, 0x00000550 ),                 /* ''' */
  EW_FONT_GLYPH( 0x0028, 0, -10, 4, 13, 4, 0x00000566 ),               /* '(' */
  EW_FONT_GLYPH( 0x0029, 0, -10, 4, 13, 4, 0x00000604 ),               /* ')' */
  EW_FONT_GLYPH( 0x002A, 0, -9, 5, 5, 5, 0x000006A2 ),                 /* '*' */
  EW_FONT_GLYPH( 0x002B, 0, -8, 7, 7, 7, 0x0000070C ),                 /* '+' */
  EW_FONT_GLYPH( 0x002C, 0, -1, 2, 3, 2, 0x00000785 ),                 /* ',' */
  EW_FONT_GLYPH( 0x002D, 0, -4, 4, 1, 3, 0x000007A4 ),                 /* '-' */
  EW_FONT_GLYPH( 0x002E, 0, -1, 3, 1, 3, 0x000007B9 ),                 /* '.' */
  EW_FONT_GLYPH( 0x002F, 0, -9, 5, 10, 5, 0x000007C3 ),                /* '/' */
  EW_FONT_GLYPH( 0x0030, 0, -9, 7, 9, 7, 0x00000852 ),                 /* '0' */
  EW_FONT_GLYPH( 0x0031, 1, -9, 4, 9, 7, 0x00000916 ),                 /* '1' */
  EW_FONT_GLYPH( 0x0032, 0, -9, 7, 9, 7, 0x00000958 ),                 /* '2' */
  EW_FONT_GLYPH( 0x0033, 0, -9, 6, 9, 7, 0x00000A42 ),                 /* '3' */
  EW_FONT_GLYPH( 0x0034, 0, -9, 7, 9, 7, 0x00000B29 ),                 /* '4' */
  EW_FONT_GLYPH( 0x0035, 0, -9, 7, 9, 7, 0x00000BDF ),                 /* '5' */
  EW_FONT_GLYPH( 0x0036, 0, -9, 7, 9, 7, 0x00000CB8 ),                 /* '6' */
  EW_FONT_GLYPH( 0x0037, 0, -9, 7, 9, 7, 0x00000D94 ),                 /* '7' */
  EW_FONT_GLYPH( 0x0038, 0, -9, 7, 9, 7, 0x00000E53 ),                 /* '8' */
  EW_FONT_GLYPH( 0x0039, 0, -9, 6, 9, 7, 0x00000F55 ),                 /* '9' */
  EW_FONT_GLYPH( 0x003A, 0, -6, 3, 6, 3, 0x0000102F ),                 /* ':' */
  EW_FONT_GLYPH( 0x003B, 0, -6, 3, 8, 3, 0x00001056 ),                 /* ';' */
  EW_FONT_GLYPH( 0x003C, 0, -6, 6, 5, 6, 0x00001095 ),                 /* '<' */
  EW_FONT_GLYPH( 0x003D, 0, -5, 6, 3, 7, 0x00001110 ),                 /* '=' */
  EW_FONT_GLYPH( 0x003E, 0, -6, 6, 5, 6, 0x0000116D ),                 /* '>' */
  EW_FONT_GLYPH( 0x003F, 0, -9, 6, 9, 6, 0x000011ED ),                 /* '?' */
  EW_FONT_GLYPH( 0x0040, 0, -8, 11, 11, 11, 0x00001291 ),              /* '@' */
  EW_FONT_GLYPH( 0x0041, 0, -9, 8, 9, 8, 0x00001469 ),                 /* 'A' */
  EW_FONT_GLYPH( 0x0042, 1, -9, 6, 9, 7, 0x00001559 ),                 /* 'B' */
  EW_FONT_GLYPH( 0x0043, 0, -9, 8, 9, 8, 0x00001612 ),                 /* 'C' */
  EW_FONT_GLYPH( 0x0044, 1, -9, 7, 9, 8, 0x000016F0 ),                 /* 'D' */
  EW_FONT_GLYPH( 0x0045, 1, -9, 6, 9, 7, 0x00001798 ),                 /* 'E' */
  EW_FONT_GLYPH( 0x0046, 1, -9, 6, 9, 7, 0x00001835 ),                 /* 'F' */
  EW_FONT_GLYPH( 0x0047, 0, -9, 8, 9, 8, 0x000018BB ),                 /* 'G' */
  EW_FONT_GLYPH( 0x0048, 1, -9, 7, 9, 9, 0x000019B8 ),                 /* 'H' */
  EW_FONT_GLYPH( 0x0049, 1, -9, 2, 9, 3, 0x00001A2F ),                 /* 'I' */
  EW_FONT_GLYPH( 0x004A, 0, -9, 6, 9, 7, 0x00001A4B ),                 /* 'J' */
  EW_FONT_GLYPH( 0x004B, 1, -9, 7, 9, 8, 0x00001AC4 ),                 /* 'K' */
  EW_FONT_GLYPH( 0x004C, 1, -9, 6, 9, 6, 0x00001B80 ),                 /* 'L' */
  EW_FONT_GLYPH( 0x004D, 1, -9, 9, 9, 10, 0x00001BD0 ),                /* 'M' */
  EW_FONT_GLYPH( 0x004E, 1, -9, 7, 9, 9, 0x00001CC1 ),                 /* 'N' */
  EW_FONT_GLYPH( 0x004F, 0, -9, 8, 9, 8, 0x00001D60 ),                 /* 'O' */
  EW_FONT_GLYPH( 0x0050, 1, -9, 7, 9, 8, 0x00001E47 ),                 /* 'P' */
  EW_FONT_GLYPH( 0x0051, 0, -9, 8, 11, 8, 0x00001F05 ),                /* 'Q' */
  EW_FONT_GLYPH( 0x0052, 0, -9, 7, 9, 7, 0x0000202E ),                 /* 'R' */
  EW_FONT_GLYPH( 0x0053, 0, -9, 7, 9, 7, 0x00002100 ),                 /* 'S' */
  EW_FONT_GLYPH( 0x0054, 0, -9, 7, 9, 7, 0x0000220D ),                 /* 'T' */
  EW_FONT_GLYPH( 0x0055, 0, -9, 8, 9, 8, 0x00002288 ),                 /* 'U' */
  EW_FONT_GLYPH( 0x0056, 0, -9, 8, 9, 8, 0x00002310 ),                 /* 'V' */
  EW_FONT_GLYPH( 0x0057, 0, -9, 11, 9, 11, 0x00002401 ),               /* 'W' */
  EW_FONT_GLYPH( 0x0058, 0, -9, 8, 9, 8, 0x00002542 ),                 /* 'X' */
  EW_FONT_GLYPH( 0x0059, 0, -9, 8, 9, 7, 0x0000263C ),                 /* 'Y' */
  EW_FONT_GLYPH( 0x005A, 0, -9, 7, 9, 7, 0x000026FE ),                 /* 'Z' */
  EW_FONT_GLYPH( 0x005B, 0, -10, 4, 12, 3, 0x000027DA ),               /* '[' */
  EW_FONT_GLYPH( 0x005C, 0, -9, 5, 10, 5, 0x00002826 ),                /* '\' */
  EW_FONT_GLYPH( 0x005D, 0, -10, 3, 12, 3, 0x000028B8 ),               /* ']' */
  EW_FONT_GLYPH( 0x005E, 0, -9, 5, 4, 5, 0x000028F6 ),                 /* '^' */
  EW_FONT_GLYPH( 0x005F, 0, 0, 6, 1, 5, 0x00002942 ),                  /* '_' */
  EW_FONT_GLYPH( 0x0060, 0, -9, 3, 2, 4, 0x00002961 ),                 /* '`' */
  EW_FONT_GLYPH( 0x0061, 0, -6, 7, 6, 7, 0x0000297F ),                 /* 'a' */
  EW_FONT_GLYPH( 0x0062, 1, -9, 6, 9, 7, 0x00002A11 ),                 /* 'b' */
  EW_FONT_GLYPH( 0x0063, 0, -6, 6, 6, 6, 0x00002AA9 ),                 /* 'c' */
  EW_FONT_GLYPH( 0x0064, 0, -9, 6, 9, 7, 0x00002B3E ),                 /* 'd' */
  EW_FONT_GLYPH( 0x0065, 0, -6, 6, 6, 6, 0x00002BD9 ),                 /* 'e' */
  EW_FONT_GLYPH( 0x0066, 0, -9, 5, 9, 4, 0x00002C85 ),                 /* 'f' */
  EW_FONT_GLYPH( 0x0067, 0, -6, 6, 9, 7, 0x00002CFB ),                 /* 'g' */
  EW_FONT_GLYPH( 0x0068, 1, -9, 5, 9, 7, 0x00002DC1 ),                 /* 'h' */
  EW_FONT_GLYPH( 0x0069, 0, -8, 3, 8, 3, 0x00002E20 ),                 /* 'i' */
  EW_FONT_GLYPH( 0x006A, -1, -8, 4, 11, 3, 0x00002E44 ),               /* 'j' */
  EW_FONT_GLYPH( 0x006B, 0, -9, 7, 9, 6, 0x00002E9D ),                 /* 'k' */
  EW_FONT_GLYPH( 0x006C, 0, -9, 2, 9, 3, 0x00002F3B ),                 /* 'l' */
  EW_FONT_GLYPH( 0x006D, 1, -6, 9, 6, 11, 0x00002F54 ),                /* 'm' */
  EW_FONT_GLYPH( 0x006E, 1, -6, 5, 6, 7, 0x00002FE7 ),                 /* 'n' */
  EW_FONT_GLYPH( 0x006F, 0, -6, 7, 6, 7, 0x00003034 ),                 /* 'o' */
  EW_FONT_GLYPH( 0x0070, 1, -6, 6, 9, 7, 0x000030D0 ),                 /* 'p' */
  EW_FONT_GLYPH( 0x0071, 0, -6, 6, 9, 7, 0x0000317A ),                 /* 'q' */
  EW_FONT_GLYPH( 0x0072, 0, -6, 4, 6, 4, 0x00003229 ),                 /* 'r' */
  EW_FONT_GLYPH( 0x0073, 0, -6, 6, 6, 6, 0x0000326C ),                 /* 's' */
  EW_FONT_GLYPH( 0x0074, 0, -8, 4, 8, 4, 0x0000330D ),                 /* 't' */
  EW_FONT_GLYPH( 0x0075, 1, -6, 5, 6, 7, 0x0000336D ),                 /* 'u' */
  EW_FONT_GLYPH( 0x0076, 0, -6, 6, 6, 6, 0x000033B5 ),                 /* 'v' */
  EW_FONT_GLYPH( 0x0077, 0, -6, 9, 6, 9, 0x0000343A ),                 /* 'w' */
  EW_FONT_GLYPH( 0x0078, 0, -6, 6, 6, 6, 0x00003514 ),                 /* 'x' */
  EW_FONT_GLYPH( 0x0079, 0, -6, 6, 9, 6, 0x000035A6 ),                 /* 'y' */
  EW_FONT_GLYPH( 0x007A, 0, -6, 6, 6, 6, 0x0000366C ),                 /* 'z' */
  EW_FONT_GLYPH( 0x007B, 0, -9, 4, 11, 4, 0x00003707 ),                /* '{' */
  EW_FONT_GLYPH( 0x007C, 1, -9, 1, 11, 3, 0x0000379C ),                /* '|' */
  EW_FONT_GLYPH( 0x007D, 0, -9, 4, 11, 4, 0x000037AD ),                /* '}' */
  EW_FONT_GLYPH( 0x007E, 0, -5, 8, 2, 8, 0x00003837 ),                 /* '~' */
  EW_FONT_GLYPH( 0x00A0, 0, 0, 0, 0, 3, 0x00003878 ),
  EW_FONT_GLYPH( 0x00A1, 0, -6, 3, 8, 3, 0x00003878 ),
  EW_FONT_GLYPH( 0x00A2, 0, -8, 7, 10, 7, 0x000038A4 ),
  EW_FONT_GLYPH( 0x00A3, 0, -9, 7, 9, 7, 0x00003971 ),
  EW_FONT_GLYPH( 0x00A4, 0, -8, 9, 8, 9, 0x00003A3E ),
  EW_FONT_GLYPH( 0x00A5, 0, -9, 7, 9, 7, 0x00003B37 ),
  EW_FONT_GLYPH( 0x00A6, 0, -9, 2, 11, 3, 0x00003C48 ),
  EW_FONT_GLYPH( 0x00A7, 0, -9, 7, 12, 7, 0x00003C73 ),
  EW_FONT_GLYPH( 0x00A8, 0, -8, 5, 1, 5, 0x00003DFC ),
  EW_FONT_GLYPH( 0x00A9, 0, -9, 9, 9, 9, 0x00003E13 ),
  EW_FONT_GLYPH( 0x00AA, 0, -9, 5, 5, 5, 0x00003F80 ),
  EW_FONT_GLYPH( 0x00AB, 0, -6, 6, 5, 6, 0x00003FE0 ),
  EW_FONT_GLYPH( 0x00AC, 0, -5, 6, 2, 7, 0x0000405E ),
  EW_FONT_GLYPH( 0x00AD, 0, -4, 4, 1, 3, 0x00004096 ),
  EW_FONT_GLYPH( 0x00AE, 0, -9, 9, 9, 9, 0x000040AB ),
  EW_FONT_GLYPH( 0x00AF, 0, -9, 5, 1, 6, 0x00004204 ),
  EW_FONT_GLYPH( 0x00B0, 0, -9, 4, 3, 4, 0x0000421F ),
  EW_FONT_GLYPH( 0x00B1, 0, -8, 6, 8, 6, 0x00004256 ),
  EW_FONT_GLYPH( 0x00B2, 0, -9, 4, 5, 4, 0x000042E2 ),
  EW_FONT_GLYPH( 0x00B3, 0, -9, 4, 5, 4, 0x0000434C ),
  EW_FONT_GLYPH( 0x00B4, 0, -9, 4, 2, 4, 0x000043AF ),
  EW_FONT_GLYPH( 0x00B5, 1, -6, 5, 9, 7, 0x000043CC ),
  EW_FONT_GLYPH( 0x00B6, 0, -9, 5, 9, 6, 0x0000442E ),
  EW_FONT_GLYPH( 0x00B7, 0, -5, 3, 1, 3, 0x000044A3 ),
  EW_FONT_GLYPH( 0x00B8, 0, 0, 3, 3, 3, 0x000044AD ),
  EW_FONT_GLYPH( 0x00B9, 0, -9, 3, 5, 4, 0x000044DC ),
  EW_FONT_GLYPH( 0x00BA, 0, -9, 5, 5, 5, 0x00004508 ),
  EW_FONT_GLYPH( 0x00BB, 0, -6, 6, 5, 6, 0x0000456D ),
  EW_FONT_GLYPH( 0x00BC, 0, -9, 9, 9, 9, 0x000045E3 ),
  EW_FONT_GLYPH( 0x00BD, 0, -9, 9, 9, 9, 0x000046DC ),
  EW_FONT_GLYPH( 0x00BE, 0, -9, 10, 9, 9, 0x000047EE ),
  EW_FONT_GLYPH( 0x00BF, 0, -6, 6, 8, 6, 0x0000493B ),
  EW_FONT_GLYPH( 0x00C0, 0, -11, 8, 12, 8, 0x000049D7 ),
  EW_FONT_GLYPH( 0x00C1, 0, -11, 8, 12, 8, 0x00004AFF ),
  EW_FONT_GLYPH( 0x00C2, 0, -11, 8, 12, 8, 0x00004C23 ),
  EW_FONT_GLYPH( 0x00C3, 0, -11, 8, 13, 8, 0x00004D57 ),
  EW_FONT_GLYPH( 0x00C4, 0, -11, 8, 11, 8, 0x00004EA1 ),
  EW_FONT_GLYPH( 0x00C5, 0, -11, 8, 13, 8, 0x00004FC5 ),
  EW_FONT_GLYPH( 0x00C6, -1, -9, 12, 9, 11, 0x0000510D ),
  EW_FONT_GLYPH( 0x00C7, 0, -9, 8, 12, 8, 0x00005264 ),
  EW_FONT_GLYPH( 0x00C8, 1, -11, 6, 12, 7, 0x00005388 ),
  EW_FONT_GLYPH( 0x00C9, 1, -11, 6, 12, 7, 0x00005457 ),
  EW_FONT_GLYPH( 0x00CA, 1, -11, 6, 12, 7, 0x00005522 ),
  EW_FONT_GLYPH( 0x00CB, 1, -11, 6, 11, 7, 0x000055FD ),
  EW_FONT_GLYPH( 0x00CC, -1, -11, 4, 12, 3, 0x000056CA ),
  EW_FONT_GLYPH( 0x00CD, 0, -11, 4, 12, 3, 0x00005724 ),
  EW_FONT_GLYPH( 0x00CE, 0, -11, 4, 12, 3, 0x0000577A ),
  EW_FONT_GLYPH( 0x00CF, -1, -11, 5, 11, 3, 0x000057E0 ),
  EW_FONT_GLYPH( 0x00D0, 0, -9, 8, 9, 8, 0x00005845 ),
  EW_FONT_GLYPH( 0x00D1, 1, -11, 7, 13, 9, 0x0000592F ),
  EW_FONT_GLYPH( 0x00D2, 0, -11, 8, 12, 8, 0x00005A24 ),
  EW_FONT_GLYPH( 0x00D3, 0, -11, 8, 12, 8, 0x00005B43 ),
  EW_FONT_GLYPH( 0x00D4, 0, -11, 8, 12, 8, 0x00005C5E ),
  EW_FONT_GLYPH( 0x00D5, 0, -11, 8, 13, 8, 0x00005D89 ),
  EW_FONT_GLYPH( 0x00D6, 0, -11, 8, 11, 8, 0x00005ECA ),
  EW_FONT_GLYPH( 0x00D7, 0, -7, 6, 6, 6, 0x00005FE5 ),
  EW_FONT_GLYPH( 0x00D8, 0, -10, 8, 11, 8, 0x00006081 ),
  EW_FONT_GLYPH( 0x00D9, 0, -11, 8, 12, 8, 0x000061C3 ),
  EW_FONT_GLYPH( 0x00DA, 0, -11, 8, 12, 8, 0x00006283 ),
  EW_FONT_GLYPH( 0x00DB, 0, -11, 8, 12, 8, 0x0000633F ),
  EW_FONT_GLYPH( 0x00DC, 0, -11, 8, 11, 8, 0x0000640B ),
  EW_FONT_GLYPH( 0x00DD, 0, -11, 8, 12, 7, 0x000064C7 ),
  EW_FONT_GLYPH( 0x00DE, 0, -9, 7, 9, 7, 0x000065BD ),
  EW_FONT_GLYPH( 0x00DF, 0, -9, 7, 9, 7, 0x00006663 ),
  EW_FONT_GLYPH( 0x00E0, 0, -9, 7, 9, 7, 0x00006727 ),
  EW_FONT_GLYPH( 0x00E1, 0, -9, 7, 9, 7, 0x000067EE ),
  EW_FONT_GLYPH( 0x00E2, 0, -9, 7, 9, 7, 0x000068B1 ),
  EW_FONT_GLYPH( 0x00E3, 0, -10, 7, 10, 7, 0x00006984 ),
  EW_FONT_GLYPH( 0x00E4, 0, -8, 7, 8, 7, 0x00006A6C ),
  EW_FONT_GLYPH( 0x00E5, 0, -10, 7, 10, 7, 0x00006B30 ),
  EW_FONT_GLYPH( 0x00E6, 0, -6, 10, 6, 10, 0x00006C16 ),
  EW_FONT_GLYPH( 0x00E7, 0, -6, 6, 9, 6, 0x00006D3A ),
  EW_FONT_GLYPH( 0x00E8, 0, -9, 6, 9, 6, 0x00006E0B ),
  EW_FONT_GLYPH( 0x00E9, 0, -9, 6, 9, 6, 0x00006EE9 ),
  EW_FONT_GLYPH( 0x00EA, 0, -9, 6, 9, 6, 0x00006FC3 ),
  EW_FONT_GLYPH( 0x00EB, 0, -8, 6, 8, 6, 0x000070AD ),
  EW_FONT_GLYPH( 0x00EC, -1, -9, 3, 9, 3, 0x00007189 ),
  EW_FONT_GLYPH( 0x00ED, 0, -9, 4, 9, 3, 0x000071CB ),
  EW_FONT_GLYPH( 0x00EE, 0, -9, 4, 9, 3, 0x00007212 ),
  EW_FONT_GLYPH( 0x00EF, -1, -8, 5, 8, 3, 0x00007269 ),
  EW_FONT_GLYPH( 0x00F0, 0, -9, 7, 9, 7, 0x000072BC ),
  EW_FONT_GLYPH( 0x00F1, 1, -10, 5, 10, 7, 0x0000739E ),
  EW_FONT_GLYPH( 0x00F2, 0, -9, 7, 9, 7, 0x00007439 ),
  EW_FONT_GLYPH( 0x00F3, 0, -9, 7, 9, 7, 0x0000750A ),
  EW_FONT_GLYPH( 0x00F4, 0, -9, 7, 9, 7, 0x000075D7 ),
  EW_FONT_GLYPH( 0x00F5, 0, -10, 7, 10, 7, 0x000076B4 ),
  EW_FONT_GLYPH( 0x00F6, 0, -8, 7, 8, 7, 0x000077A6 ),
  EW_FONT_GLYPH( 0x00F7, 0, -7, 7, 5, 7, 0x00007874 ),
  EW_FONT_GLYPH( 0x00F8, 0, -7, 7, 8, 7, 0x000078EC ),
  EW_FONT_GLYPH( 0x00F9, 1, -9, 5, 9, 7, 0x000079CB ),
  EW_FONT_GLYPH( 0x00FA, 1, -9, 5, 9, 7, 0x00007A42 ),
  EW_FONT_GLYPH( 0x00FB, 1, -9, 5, 9, 7, 0x00007AB5 ),
  EW_FONT_GLYPH( 0x00FC, 1, -8, 5, 8, 7, 0x00007B38 ),
  EW_FONT_GLYPH( 0x00FD, 0, -9, 6, 12, 6, 0x00007BAE ),
  EW_FONT_GLYPH( 0x00FE, 0, -9, 7, 12, 7, 0x00007CA2 ),
  EW_FONT_GLYPH( 0x00FF, 0, -8, 6, 11, 6, 0x00007D61 ),

  EW_FONT_PIXEL( EwFont_Roboto_HC14_C16, 0x00007E57 )           /* ratio 79.19 % */
  ...
  EW_FONT_KERNING_CODES( EwFont_Roboto_HC14_C16 )
  EW_FONT_KERNING_VALUES( EwFont_Roboto_HC14_C16 )
EW_END_OF_BITMAP_FONT( EwFont_Roboto_HC14_C16 )
