...
#ifndef _ApplicationTimerConfigure_H
#define _ApplicationTimerConfigure_H
...
EW_DEFINE_FIELDS( ApplicationTimerConfigure, CoreGroup )
  EW_OBJECT  ( TimerText,       ViewsText )
  EW_PROPERTY( TimerSeconds,    XInt32 )
EW_END_OF_FIELDS( ApplicationTimerConfigure )

/* Virtual Method Table (VMT) for the class : 'Application::TimerConfigure' */
EW_DEFINE_METHODS( ApplicationTimerConfigure, CoreGroup )
...
EW_END_OF_METHODS( ApplicationTimerConfigure )
...
#endif /* _ApplicationTimerConfigure_H */
